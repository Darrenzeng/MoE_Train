...
import sys
from .configuration_qwen2moe import Qwen2MoEConfig
...
class QwenBlockSparseTop2MLP(nn.Module):
...
class QwenSparseMoeBlock(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.experts = nn.ModuleList([QwenBlockSparseTop2MLP(config) for _ in range(self.num_experts)])
...
class Qwen2MoEDecoderLayer(nn.Module):
    def __init__(self, config: Qwen2MoEConfig, layer_idx: int):
        ...
        self.block_sparse_moe = QwenSparseMoeBlock(config)
...
class Qwen2ForSequenceClassification(Qwen2MoEPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
